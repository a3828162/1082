...
void Reservation::displayReservationDetails()
{
    ...
    cout << setw(10) << "Date" << setw(11) << "Train NO." << setw(10) << "From" << setw(10) << "To" << setw(11)
        ...
        << setw(10) << "Class" << endl;
    cout << setw(10) << date << setw(11) << trainNumber;
    if (originStation < destinationStation)
    {
        cout << setw(10) << Station[originStation]
            << setw(10) << Station[destinationStation];
        cout << setw(11) << sou.getDepartureTimes(trainNumber, originStation)
            << setw(9) << sou.getDepartureTimes(trainNumber, destinationStation);
        if (carClass == 1)
        {
            cout << setw(6) << adultTicketPrice[destinationStation][originStation]
                << "*" << adultTickets
                << setw(10) << adultTicketPrice[destinationStation][originStation] / 2
                << "*" << concessionTickets
        ...
        {
            cout << setw(6) << adultTicketPrice[originStation][destinationStation]
                << "*" << adultTickets
                << setw(10) << adultTicketPrice[originStation][destinationStation] / 2
                << "*" << concessionTickets
    ...
    else
    {
        cout << setw(10) << Station[originStation]
            << setw(10) << Station[destinationStation];
        cout << setw(11) << nor.getDepartureTimes(trainNumber, 13 - originStation)
