...
public:
   ...
   void push_front(const Ty& val)
   {
       ...
       else
       {
           ...
           if (newPosition % 4 == 3 && myData.mySize >= 4 * (myData.mapSize - 1))
           {
               doubleMapSize();
           ...
           myData.map[newPosition / 4][newPosition % 4] = val;
   ...
   void push_back( const Ty &val )
   {
       ...
       else
       {
           ...
           if (newPosition % 4 == 0 && myData.mySize >= 4 * (myData.mapSize - 1))
           {
               doubleMapSize();
               newPosition = myData.myOff + myData.mySize;
           }
           else
...
//      return ( ( myData.off / 4 ) & ( myData.mapSize - 1 ) );
   ...
   void doubleMapSize()
   {
      if( myData.mapSize > 0 )
      {
          ...
          for (unsigned int i = 0; i < myData.mapSize; ++i)
              if (myData.map[i] != nullptr)
                  delete[]myData.map[i];
          delete[]myData.map;
          myData.map = newmap;
