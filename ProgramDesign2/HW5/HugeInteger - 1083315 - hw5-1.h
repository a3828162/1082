...
#include "Vector - 1083315 - hw5.h" // include definition of class vector 
...
HugeInteger< T > HugeInteger< T >::operator-( HugeInteger< T > &op2 )
{
   ...
   typename vector< T >::iterator it1 = op2.integer.begin();
   typename vector< T >::iterator it2 = difference.integer.begin();

   int* a = new int[difference.integer.size()]();
   for (unsigned int i = 0; i < difference.integer.size(); i++)
       a[i] = difference.integer.begin()[i];
...
HugeInteger< T > HugeInteger< T >::operator/( HugeInteger< T > &op2 )
{
   ...
   typename vector< T >::iterator it1 = integer.begin();
   typename vector< T >::iterator it2 = op2.integer.begin();
   typename vector< T >::iterator it3 = quotient.integer.begin();
   typename vector< T >::iterator it4 = remainder.integer.begin();

   unsigned int bufferSize = divisorSize + n;

   HugeInteger buffer(dividendSize);
   typename vector< T >::iterator it5 = buffer.integer.begin();
